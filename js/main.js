...
const translations = {
  uz: {
    ...
    greeting:
      "Assalomu alaykum! Men Alijon Umaraliyev - matematika o'qituvchisiman.",
    intro_text:
  ...
  en: {
    ...
    greeting: "Hello! I am Alijon Umaraliyev - a mathematics teacher.",
    intro_text:
    ...
    about_text:
      "Hello! I am Alijon Umaraliyev, a mathematics teacher with 2 years of experience. I am dedicated to my work and strive to enhance my students' knowledge through mathematics. For me, teaching is not just about giving lessons, but helping students become a great source of knowledge. Mathematics, in my opinion, is not limited to calculations but requires problem-solving, development of logical thinking, and creative approaches. In teaching this subject, I always try to take into account the personal needs and interests of students.",
  ...
  ru: {
    ...
    greeting: "Здравствуйте! Я Алижон Умаралиев - учитель математики.",
    intro_text:
...
document
  .getElementById("mobileLanguageSelector")
